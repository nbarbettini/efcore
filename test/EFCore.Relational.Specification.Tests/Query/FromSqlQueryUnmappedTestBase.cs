...
public abstract class FromSqlQueryUnmappedTestBase<TFixture> : QueryTestBase<TFixture>
    where TFixture : NorthwindQueryRelationalFixture<NoopModelCustomizer>, new()
{
    // ReSharper disable once StaticMemberInGenericType
    private static readonly string _eol = Environment.NewLine;

    protected FromSqlQueryUnmappedTestBase(TFixture fixture)
        : base(fixture)
    {
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_simple_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>())
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_simple_columns_out_of_order_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(
                NormalizeDelimitersInRawString(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_simple_columns_out_of_order_and_extra_columns_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(
                NormalizeDelimitersInRawString(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_composed_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(NormalizeDelimitersInRawString("SELECT * FROM [Customers]"))
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_composed_after_removing_whitespaces_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(
                    NormalizeDelimitersInRawString(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_queryable_composed_compiled_unmapped(bool async)
    {
        if (async)
        {
            var query = EF.CompileAsyncQuery(
                (NorthwindContext context) => context.Set<UnmappedCustomer>()
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_queryable_composed_compiled_with_parameter_unmapped(bool async)
    {
        if (async)
        {
            var query = EF.CompileAsyncQuery(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_queryable_composed_compiled_with_DbParameter_unmapped(bool async)
    {
        if (async)
        {
            var query = EF.CompileAsyncQuery(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_queryable_composed_compiled_with_nameless_DbParameter_unmapped(bool async)
    {
        if (async)
        {
            var query = EF.CompileAsyncQuery(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_composed_contains_unmapped(bool async)
        => AssertQuery(
            async,
            ss => from c in ss.Set<UnmappedCustomer>()
                  where ((DbSet<UnmappedOrder>)ss.Set<UnmappedOrder>()).FromSqlRaw(NormalizeDelimitersInRawString("SELECT * FROM [Orders]"))
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_composed_contains2_unmapped(bool async)
        => AssertQuery(
            async,
            ss => from c in ss.Set<UnmappedCustomer>()
                  where
                      c.CustomerID == "ALFKI"
                      && ((DbSet<UnmappedOrder>)ss.Set<UnmappedOrder>()).FromSqlRaw(NormalizeDelimitersInRawString("SELECT * FROM [Orders]"))
                      .Select(o => o.CustomerID)
                      .Contains(c.CustomerID)
                  select c,
            ss => from c in ss.Set<Customer>()
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_multiple_composed_unmapped(bool async)
        => AssertQuery(
            async,
            ss => from c in ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(NormalizeDelimitersInRawString("SELECT * FROM [Customers]"))
                  from o in ((DbSet<UnmappedOrder>)ss.Set<UnmappedOrder>()).FromSqlRaw(NormalizeDelimitersInRawString("SELECT * FROM [Orders]"))
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_multiple_composed_with_closure_parameters_unmapped(bool async)
    {
        ...
        return AssertQuery(
            async,
            ss => from c in ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(NormalizeDelimitersInRawString("SELECT * FROM [Customers]"))
                  from o in ((DbSet<UnmappedOrder>)ss.Set<UnmappedOrder>()).FromSqlRaw(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_queryable_multiple_composed_with_parameters_and_closure_parameters_unmapped(bool async)
    {
        var city = "London";
        var startDate = new DateTime(1997, 1, 1);
        var endDate = new DateTime(1998, 1, 1);
        ...
        await AssertQuery(
            async,
            ss => from c in ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_multiple_line_query_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(
                NormalizeDelimitersInRawString(
...
WHERE [City] = 'London'")),
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_composed_multiple_line_query_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(
                    NormalizeDelimitersInRawString(
...
FROM [Customers]"))
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_with_parameters_unmapped(bool async)
    {
        var city = "London";
        ...
        return AssertQuery(
            ...
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(
                ...
                contactTitle),
            ss => ss.Set<Customer>().Where(x => x.City == city && x.ContactTitle == contactTitle).Select(e => UnmappedCustomer.FromCustomer(e)),
            elementSorter: e => e.CustomerID,
            elementAsserter: AssertUnmappedCustomers,
            entryCount: 0);
    }
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_with_parameters_inline_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(
                NormalizeDelimitersInRawString("SELECT * FROM [Customers] WHERE [City] = {0} AND [ContactTitle] = {1}"), "London",
                "Sales Representative"),
            ss => ss.Set<Customer>().Where(x => x.City == "London" && x.ContactTitle == "Sales Representative").Select(e => UnmappedCustomer.FromCustomer(e)),
            elementSorter: e => e.CustomerID,
            elementAsserter: AssertUnmappedCustomers,
            entryCount: 0);
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlInterpolated_queryable_with_parameters_interpolated_unmapped(bool async)
    {
        var city = "London";
        var contactTitle = "Sales Representative";
        ...
        return AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlInterpolated(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSql_queryable_with_parameters_interpolated_unmapped(bool async)
    {
        var city = "London";
        var contactTitle = "Sales Representative";
        ...
        return AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSql(
                NormalizeDelimitersInInterpolatedString(
                    $"SELECT * FROM [Customers] WHERE [City] = {city} AND [ContactTitle] = {contactTitle}")),
            ss => ss.Set<Customer>().Where(x => x.City == city && x.ContactTitle == contactTitle).Select(e => UnmappedCustomer.FromCustomer(e)),
            elementSorter: e => e.CustomerID,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlInterpolated_queryable_with_parameters_inline_interpolated_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlInterpolated(
                NormalizeDelimitersInInterpolatedString(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSql_queryable_with_parameters_inline_interpolated_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSql(
                NormalizeDelimitersInInterpolatedString(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlInterpolated_queryable_multiple_composed_with_parameters_and_closure_parameters_interpolated_unmapped(
        bool async)
    {
        var city = "London";
        var startDate = new DateTime(1997, 1, 1);
        ...
        await AssertQuery(
            ...
            ss => from c in ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(
                      NormalizeDelimitersInRawString("SELECT * FROM [Customers] WHERE [City] = {0}"), city)
                  from o in ((DbSet<UnmappedOrder>)ss.Set<UnmappedOrder>()).FromSqlInterpolated(
                      NormalizeDelimitersInInterpolatedString(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSql_queryable_multiple_composed_with_parameters_and_closure_parameters_interpolated_unmapped(
        bool async)
    {
        var city = "London";
        var startDate = new DateTime(1997, 1, 1);
        ...
        await AssertQuery(
            ...
            ss => from c in ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(
                      NormalizeDelimitersInRawString("SELECT * FROM [Customers] WHERE [City] = {0}"), city)
                  from o in ((DbSet<UnmappedOrder>)ss.Set<UnmappedOrder>()).FromSql(
                      NormalizeDelimitersInInterpolatedString(
                          $"SELECT * FROM [Orders] WHERE [OrderDate] BETWEEN {startDate} AND {endDate}"))
                  where c.CustomerID == o.CustomerID
                  select new { c, o },
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_with_null_parameter_unmapped(bool async)
    {
        uint? reportsTo = null;

        return AssertQuery(
            async,
            ss => ((DbSet<UnmappedEmployee>)ss.Set<UnmappedEmployee>()).FromSqlRaw(
                NormalizeDelimitersInRawString(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task<string> FromSqlRaw_queryable_with_parameters_and_closure_unmapped(bool async)
    {
        var city = "London";
        var contactTitle = "Sales Representative";

        using var context = CreateContext();
        var query = context.Set<UnmappedCustomer>().FromSqlRaw(
                NormalizeDelimitersInRawString("SELECT * FROM [Customers] WHERE [City] = {0}"), city)
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_queryable_simple_cache_key_includes_query_string_unmapped(bool async)
    {
        await AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>())
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_queryable_with_parameters_cache_key_includes_parameters_unmapped(bool async)
    {
        var city = "London";
        var contactTitle = "Sales Representative";
        ...
        await AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(NormalizeDelimitersInRawString(sql), city, contactTitle),
            ss => ss.Set<Customer>().Where(x => x.City == city && x.ContactTitle == contactTitle).Select(e => UnmappedCustomer.FromCustomer(e)),
            elementSorter: e => e.CustomerID,
            elementAsserter: AssertUnmappedCustomers,
            entryCount: 0);
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_simple_as_no_tracking_not_composed_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>())
                .FromSqlRaw(NormalizeDelimitersInRawString("SELECT * FROM [Customers]"))
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_queryable_simple_projection_composed_unmapped(bool async)
    {
        using var context = CreateContext();
        ...
        await AssertQuery(
            async,
            ss => ((DbSet<UnmappedProduct>)ss.Set<UnmappedProduct>()).FromSqlRaw(
                    NormalizeDelimitersInRawString(
                        @"SELECT *
FROM [Products]
WHERE [Discontinued] <> "
...
AND (([UnitsInStock] + [UnitsOnOrder]) < [ReorderLevel])"))
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_annotations_do_not_affect_successive_calls_unmapped(bool async)
    {
        using var context = CreateContext();
        var query = context.Set<UnmappedCustomer>()
            .FromSqlRaw(NormalizeDelimitersInRawString("SELECT * FROM [Customers] WHERE [ContactName] LIKE '%z%'"));
        ...
        query = context.Set<UnmappedCustomer>();
        actual = async
            ? await query.ToArrayAsync()
            : query.ToArray();
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_composed_with_nullable_predicate_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>())
                .FromSqlRaw(NormalizeDelimitersInRawString("SELECT * FROM [Customers]"))
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_with_dbParameter_unmapped(bool async)
    {
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_with_dbParameter_without_name_prefix_unmapped(bool async)
    {
        var parameter = CreateDbParameter("city", "London");
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_with_dbParameter_mixed_unmapped(bool async)
    {
        var city = "London";
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_with_db_parameters_called_multiple_times_unmapped(bool async)
    {
        using var context = CreateContext();
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlInterpolated_with_inlined_db_parameter_unmapped(bool async)
    {
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSql_with_inlined_db_parameter_unmapped(bool async)
    {
        var parameter = CreateDbParameter("@somename", "ALFKI");
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlInterpolated_with_inlined_db_parameter_without_name_prefix_unmapped(bool async)
    {
        var parameter = CreateDbParameter("somename", "ALFKI");
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSql_with_inlined_db_parameter_without_name_prefix_unmapped(bool async)
    {
        var parameter = CreateDbParameter("somename", "ALFKI");
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlInterpolated_parameterization_issue_12213_unmapped(bool async)
    {
        using var context = CreateContext();
        var min = 10300;
        var max = 10400;

        var query1 = context.Set<UnmappedOrder>()
        ...
        var query2 = context.Set<UnmappedOrder>()
        ...
        var query3 = context.Set<UnmappedOrder>()
            .Where(
                o => o.OrderID <= max
                    && context.Set<UnmappedOrder>()
                        .FromSqlInterpolated(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_does_not_parameterize_interpolated_string_unmapped(bool async)
    {
        ...
        await AssertQuery(
            async,
            ss => ((DbSet<UnmappedOrder>)ss.Set<UnmappedOrder>()).FromSqlRaw(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_with_set_operation_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>())
                .FromSqlRaw(NormalizeDelimitersInRawString("SELECT * FROM [Customers] WHERE [City] = 'London'"))
                .Concat(
                    ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>())
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Line_endings_after_Select_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>())
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_queryable_simple_projection_not_composed_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>())
                .FromSqlRaw(NormalizeDelimitersInRawString("SELECT * FROM [Customers]"))
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_in_subquery_with_dbParameter_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<UnmappedOrder>().Where(
                o => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>()).FromSqlRaw(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_in_subquery_with_positional_dbParameter_without_name_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<UnmappedOrder>().Where(
                o => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>())
                    .FromSqlRaw(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_in_subquery_with_positional_dbParameter_with_name_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ss.Set<UnmappedOrder>().Where(
                o => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>())
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task FromSqlRaw_with_dbParameter_mixed_in_subquery_unmapped(bool async)
    {
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FromSqlRaw_composed_with_common_table_expression_unmapped(bool async)
        => AssertQuery(
            async,
            ss => ((DbSet<UnmappedCustomer>)ss.Set<UnmappedCustomer>())
                .FromSqlRaw(
...
SELECT * FROM [Customers2]"))
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task Multiple_occurrences_of_FromSql_with_db_parameter_adds_parameter_only_once_unmapped(bool async)
    {
        using var context = CreateContext();
        var city = "Seattle";
        var fromSqlQuery = context.Set<UnmappedCustomer>().FromSqlRaw(
            NormalizeDelimitersInRawString(@"SELECT * FROM [Customers] WHERE [City] = {0}"),
            CreateDbParameter("city", city));
